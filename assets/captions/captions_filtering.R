...
caption_tab_ssu("ssu_asv_pime_sum", "Changes in read count and total ASVs during PIME filtering.")
...
caption_tab_its("its_asv_pime_sum", "Changes in read count and total ASVs during PIME filtering.")
