...
seq_table <- read.table("files/data-prep/tables/ssu_summary_table.txt", header = TRUE)
joined_tab <- seq_table 
seq_table %>%
  download_this(
    output_name = "ssu_sample_summary",
...
<small>`r caption_tab("metadata_summary_ssu")`</small>
```{r, echo=FALSE, layout="l-body", eval=TRUE}
seq_table <- md_summary 
seq_table %>%
  download_this(
    output_name = "ssu_metadata_summary",
    output_extension = ".csv",
    button_label = "Download data as csv file",
    button_type = "default",
    csv2 = FALSE,
...
seq_table <- na.omit(ssu_sample_summary_final) 
seq_table %>%
  download_this(
    output_name = "ssu_sample_summary_final",
    output_extension = ".csv",
    button_label = "Download data as csv file",
    button_type = "default",
    csv2 = FALSE,
...
```{r, echo=FALSE, layout="l-page", eval=TRUE}
seq_table <- read.table("files/data-prep/tables/its_summary_table.txt", header = TRUE)
joined_tab <- seq_table 
seq_table %>%
  download_this(
    output_name = "its_sample_summary",
    output_extension = ".csv",
    button_label = "Download data as csv file",
    button_type = "default",
    csv2 = FALSE,
...
<small>`r caption_tab("metadata_summary_its")`</small>
```{r, echo=FALSE, layout="l-body", eval=TRUE}
seq_table <- md_summary 
seq_table %>%
  download_this(
    output_name = "its_metadata_summary",
    output_extension = ".csv",
    button_label = "Download data as csv file",
    button_type = "default",
    csv2 = FALSE,
...
reactable(seq_table,
  ...
  columns = list(
    category = colDef(name = "category", 
                       ...
                       align = "left",
                       minWidth = 100),
  count = colDef(name = "no. samples", filterable = FALSE)),
  searchable = TRUE, defaultPageSize = 5, 
  pageSizeOptions = c(5, 10, nrow(seq_table)), 
  showPageSizeOptions = TRUE, highlight = TRUE, 
  bordered = TRUE, striped = TRUE, compact = FALSE, 
...
<small>`r caption_tab("neg_control_check_its")`</small>
```{r, echo=FALSE, layout="l-body-outset", eval=TRUE}
seq_table <- ps_no_nc_check_t 
seq_table %>%
  download_this(
    output_name = "its_negative_control_check",
    output_extension = ".csv",
    button_label = "Download data as csv file",
    button_type = "default",
    csv2 = FALSE,
...
```{r, echo=FALSE, layout="l-body-outset", eval=TRUE}
seq_table <- na.omit(its_sample_summary_final) 
seq_table %>%
  download_this(
    output_name = "its_sample_summary_final",
    output_extension = ".csv",
    button_label = "Download data as csv file",
    button_type = "default",
    csv2 = FALSE,
...
You can find the source code for this page by [clicking this link](https://github.com/sweltr/sweltr-web/blob/master/agua-data-prep.Rmd).
