...
source("assets/reactable/table_functions/da.R")
```
...
remove(list = ls())
ssu_ps_work_Y0 <- readRDS("files/alpha/rdata/ssu_ps_work_Y0.rds")
ssu_ps_work_Y1 <- readRDS("files/alpha/rdata/ssu_ps_work_Y1.rds")
ssu_ps_work_Y4 <- readRDS("files/alpha/rdata/ssu_ps_work_Y4.rds")

ssu_ps_filt_Y0 <- readRDS("files/alpha/rdata/ssu_ps_filt_Y0.rds")
ssu_ps_filt_Y1 <- readRDS("files/alpha/rdata/ssu_ps_filt_Y1.rds")
ssu_ps_filt_Y4 <- readRDS("files/alpha/rdata/ssu_ps_filt_Y4.rds")

ssu_ps_perfect_Y0 <- readRDS("files/alpha/rdata/ssu_ps_perfect_Y0.rds")
ssu_ps_perfect_Y1 <- readRDS("files/alpha/rdata/ssu_ps_perfect_Y1.rds")
ssu_ps_perfect_Y4 <- readRDS("files/alpha/rdata/ssu_ps_perfect_Y4.rds")

ssu_ps_pime_Y0 <- readRDS("files/alpha/rdata/ssu_ps_pime_Y0.rds")
ssu_ps_pime_Y1 <- readRDS("files/alpha/rdata/ssu_ps_pime_Y1.rds")
ssu_ps_pime_Y4 <- readRDS("files/alpha/rdata/ssu_ps_pime_Y4.rds")
objects()
```


```{r, echo=FALSE}
samp_ps <- c("ssu_ps_work_Y0", "ssu_ps_work_Y1", "ssu_ps_work_Y4",
...
#     tmp_sum_tax$group <- stringr::str_replace(tmp_sum_tax$group, "^5$", "Y1_CTL")
#     tmp_sum_tax$group <- stringr::str_replace(tmp_sum_tax$group, "^6$", "Y1_N")
#     tmp_sum_tax$group <- stringr::str_replace(tmp_sum_tax$group, "^7$", "Y1_NP")
#     tmp_sum_tax$group <- stringr::str_replace(tmp_sum_tax$group, "^8$", "Y1_P")
           
#     tmp_sum_tax$group <- stringr::str_replace(tmp_sum_tax$group, "^9$", "Y4_CTL")
#     tmp_sum_tax$group <- stringr::str_replace(tmp_sum_tax$group, "^10$", "Y4_N")
#     tmp_sum_tax$group <- stringr::str_replace(tmp_sum_tax$group, "^11$", "Y4_NP")
#     tmp_sum_tax$group <- stringr::str_replace(tmp_sum_tax$group, "^12$", "Y4_P")
...
for (i in objects(pattern = "_indval_summary")){
  cat(i, nrow(get(i)), "\n")
}
```
...
```{r, echo=FALSE}
rm(ssu_inval_sum_tab)
ssu_inval_sum_tab <- c()
for (i in objects(pattern = "_ind$")) {
  tmp_ps <- get(i)
  tmp_o_ps <- get(gsub("_ind", "", i))

  tmp_rc <- sum(readcount(tmp_ps))
  tmp_rc_o <- sum(readcount(tmp_o_ps))
  tmp_per_rc <- 100*(sum(readcount(tmp_ps)) / sum(readcount(tmp_o_ps)))

  tmp_tc <- ntaxa(tmp_ps)
  tmp_tc_o <- ntaxa(tmp_o_ps)
  tmp_per_tc <- 100*(ntaxa(tmp_ps) / ntaxa(tmp_o_ps))
  tmp_ds <- stringr::str_remove(i, ".*_ps_") %>%
                 stringr::str_remove(., "_.*")
  tmp_year <- stringr::str_remove(i, "_ind") %>%
                 stringr::str_remove(., ".*_Y")  %>%
                 paste("Year", ., sep = " ")

  ssu_inval_sum_tab <- data.frame(rbind(ssu_inval_sum_tab, c(tmp_ds, tmp_year,
                                                     tmp_rc_o, tmp_rc, tmp_per_rc, 
                                                     tmp_tc_o, tmp_tc, tmp_per_tc)))
  ssu_inval_sum_tab <- ssu_inval_sum_tab %>% dplyr::rename("dataset" = 1, "year" = 2,
                                                   "total_reads" = 3, "indval_reads" = 4, "per_reads" = 5, 
                                                   "total_asvs" = 6, "indval_asvs" = 7, "per_asvs" = 8) 

  rm(list = ls(pattern = "tmp_"))
}
tmp_tab <- ssu_inval_sum_tab
tmp_tab <- tmp_tab %>% dplyr::slice(10:12,1:9)
tmp_tab$dataset <- gsub("work", "FULL data set", tmp_tab$dataset)
tmp_tab$dataset <- gsub("filt", "Arbitrary filtered", tmp_tab$dataset)
tmp_tab$dataset <- gsub("perfect", "PERFect filtered", tmp_tab$dataset)
tmp_tab$dataset <- gsub("pime", "PIME filtered", tmp_tab$dataset)

tmp_tab <- purrr::modify_at(tmp_tab, .at = c(5,8), ~as.numeric(as.character(.)))
tmp_tab <- purrr::modify_at(tmp_tab, .at = c(3:4,6:7), ~as.integer(as.character(.)))
ssu_inval_sum_tab <- tmp_tab
rm(tmp_tab)
```


<small>`r caption_tab_ssu("ssu_inval_sum_tab")`</small>

```{r, echo=FALSE, eval=TRUE}
download_this_fun(ssu_inval_sum_tab)
```

```{r, echo=FALSE, eval=TRUE, layout="l-page"}
indval_summ_table(seq_table)
rm(seq_table)
```
...
<small>`r caption_tab_ssu("ssu_isa_full_Y0")`</small>

```{r, echo=FALSE, eval=TRUE}
download_this_fun(ssu_ps_work_Y0_indval_final)
```

```{r, echo=FALSE, layout="l-page", eval=TRUE}
indval_table(seq_table)
rm(seq_table)
```
:::
...
<small>`r caption_tab_ssu("ssu_isa_full_Y1")`</small>

```{r, echo=FALSE, eval=TRUE}
download_this_fun(ssu_ps_work_Y1_indval_final)
```
...
<small>`r caption_tab_ssu("ssu_isa_full_Y4")`</small>

```{r, echo=FALSE, eval=TRUE}
download_this_fun(ssu_ps_work_Y4_indval_final)
```
...
<small>`r caption_tab_ssu("ssu_isa_filt_Y0")`</small>

```{r, echo=FALSE, eval=TRUE}
download_this_fun(ssu_ps_filt_Y0_indval_final)
```
...
<small>`r caption_tab_ssu("ssu_isa_filt_Y1")`</small>

```{r, echo=FALSE, eval=TRUE}
download_this_fun(ssu_ps_filt_Y1_indval_final)
```
...
<small>`r caption_tab_ssu("ssu_isa_filt_Y4")`</small>

```{r, echo=FALSE, eval=TRUE}
download_this_fun(ssu_ps_filt_Y4_indval_final)
```
...
<small>`r caption_tab_ssu("ssu_isa_perfect_Y0")`</small>

```{r, echo=FALSE, eval=TRUE}
download_this_fun(ssu_ps_perfect_Y0_indval_final)
```
...
<small>`r caption_tab_ssu("ssu_isa_perfect_Y1")`</small>

```{r, echo=FALSE, eval=TRUE}
download_this_fun(ssu_ps_perfect_Y1_indval_final)
```
...
<small>`r caption_tab_ssu("ssu_isa_perfect_Y4")`</small>

```{r, echo=FALSE, eval=TRUE}
download_this_fun(ssu_ps_perfect_Y4_indval_final)
```
...
<small>`r caption_tab_ssu("ssu_isa_pime_Y0")`</small>

```{r, echo=FALSE, eval=TRUE}
download_this_fun(ssu_ps_pime_Y0_indval_final)
```
...
<small>`r caption_tab_ssu("ssu_isa_pime_Y1")`</small>

```{r, echo=FALSE, eval=TRUE}
download_this_fun(ssu_ps_pime_Y1_indval_final)
```
...
<small>`r caption_tab_ssu("ssu_isa_pime_Y4")`</small>

```{r, echo=FALSE, eval=TRUE}
download_this_fun(ssu_ps_pime_Y4_indval_final)
```
...
```{r, echo=FALSE}
for (i in objects(pattern = "_indval_final")) {
  tmp_get <- get(i)
  tmp_get <- tmp_get %>% dplyr::rename("reads" = "reads_total")
  tmp_get <- tmp_get %>% dplyr::select(-contains("freq_")) %>% 
                         dplyr::select(-contains("reads_"))
  tmp_get$group <- gsub("^Y[0-9]_", "", tmp_get$group)

  tmp_year <- stringr::str_remove(i, "_indval_final") %>%
                 stringr::str_remove(., ".*_")
  tmp_ds <- stringr::str_remove(i, "_indval_final") %>%
                 stringr::str_remove(., "_Y[0-9]")
  tmp_group <- paste("group", tmp_year, sep = "_")
  tmp_indval <- paste("indval", tmp_year, sep = "_")
  tmp_pval <- paste("pval", tmp_year, sep = "_")
  tmp_freq <- paste("freq", tmp_year, sep = "_")
  tmp_reads <- paste("reads", tmp_year, sep = "_")

  tmp_new_names <- c(tmp_group, tmp_indval, tmp_pval, tmp_freq, tmp_reads)
  tmp_old_names <- c("group", "indval", "pval", "freq", "reads")
  tmp_get <- tmp_get %>% dplyr::rename_with(~tmp_new_names, tmp_old_names)
  tmp_df_name <- paste(tmp_ds, "_", tmp_year, "_to_comb", sep = "")
  assign(tmp_df_name, tmp_get)
  rm(list = ls(pattern = "tmp_"))
}
```

```{r, echo=FALSE}
join_list <- c("ASV_ID", "Kingdom", "Phylum", "Class", "Order", "Family", "Genus", "ASV_SEQ")
reorder_list <- c("ASV_ID", "group_Y0", "group_Y1", "group_Y4", "reads_Y0", "reads_Y1", "reads_Y4", 
                  "freq_Y0", "freq_Y1", "freq_Y4", "indval_Y0", "indval_Y1", "indval_Y4", 
                  "pval_Y0", "pval_Y1", "pval_Y4", 
                  "Kingdom", "Phylum", "Class", "Order", "Family", "Genus", "ASV_SEQ")
ssu_ps_work_isa_combo <- dplyr::full_join(ssu_ps_work_Y0_to_comb, ssu_ps_work_Y1_to_comb, by = join_list) %>%
  dplyr::full_join(., ssu_ps_work_Y4_to_comb, by = join_list) %>% 
  dplyr::select(all_of(reorder_list))

ssu_ps_filt_isa_combo <- dplyr::full_join(ssu_ps_filt_Y0_to_comb, ssu_ps_filt_Y1_to_comb, by = join_list) %>%
  dplyr::full_join(., ssu_ps_filt_Y4_to_comb, by = join_list) %>% 
  dplyr::select(all_of(reorder_list))

ssu_ps_perfect_isa_combo <- dplyr::full_join(ssu_ps_perfect_Y0_to_comb, ssu_ps_perfect_Y1_to_comb, by = join_list) %>%
  dplyr::full_join(., ssu_ps_perfect_Y4_to_comb, by = join_list) %>% 
  dplyr::select(all_of(reorder_list))

ssu_ps_pime_isa_combo <- dplyr::full_join(ssu_ps_pime_Y0_to_comb, ssu_ps_pime_Y1_to_comb, by = join_list) %>%
  dplyr::full_join(., ssu_ps_pime_Y4_to_comb, by = join_list) %>% 
  dplyr::select(all_of(reorder_list))

rm(list = ls(pattern = "_to_comb$"))
```
...
<small>`r caption_tab_ssu("ssu_ps_work_isa_combo")`</small>

```{r, echo=FALSE, eval=TRUE}
download_this_fun(ssu_ps_work_isa_combo)
```

```{r, echo=FALSE, layout="l-page", eval=TRUE}
combo_table(seq_table)
rm(seq_table)
```
:::
...
<small>`r caption_tab_ssu("ssu_ps_filt_isa_combo")`</small>

```{r, echo=FALSE, eval=TRUE}
download_this_fun(ssu_ps_filt_isa_combo)
```
...
<small>`r caption_tab_ssu("ssu_ps_perfect_isa_combo")`</small>

```{r, echo=FALSE, eval=TRUE}
download_this_fun(ssu_ps_perfect_isa_combo)
```
...
<small>`r caption_tab_ssu("ssu_ps_pime_isa_combo")`</small>

```{r, echo=FALSE, eval=TRUE}
download_this_fun(ssu_ps_pime_isa_combo)
```
...
1. Choose and set the LEfSe cutoff values.
...
#tmp_tab <- data.frame(marker_table(ssu_ps_pime_lefse_asv))
#tmp_tab$feature <- gsub('s__', '', tmp_tab$feature)

#tmp_ps <- data.frame(t(otu_table(ssu_ps_pime_rf_asv)))
...
ssu_ps_filt_Y0_lefse_asv_summary
```
...
ssu_ps_filt_Y0_lefse_asv_final
```
...
```{r, echo=FALSE}
rm(ssu_lefse_sum_tab)
ssu_lefse_sum_tab <- c()
for (i in objects(pattern = "_lefse_asv_ps$")) {
  tmp_ps <- get(i)
  tmp_o_ps <- get(gsub("_lefse_asv_ps", "", i))
  ...
  tmp_ds <- stringr::str_remove(i, ".*_ps_") %>%
                 stringr::str_remove(., "_.*")
  tmp_year <- stringr::str_remove(i, "_lefse_asv_ps") %>%
                 stringr::str_remove(., ".*_Y")  %>%
                 paste("Year", ., sep = " ")

  ssu_lefse_sum_tab <- data.frame(rbind(ssu_lefse_sum_tab, c(tmp_ds, tmp_year,
                                                     tmp_rc_o, tmp_rc, tmp_per_rc, 
                                                     tmp_tc_o, tmp_tc, tmp_per_tc)))
  ssu_lefse_sum_tab <- ssu_lefse_sum_tab %>% dplyr::rename("dataset" = 1, "year" = 2,
                                                   "total_reads" = 3, "lefse_reads" = 4, "per_reads" = 5, 
                                                   "total_asvs" = 6, "lefse_asvs" = 7, "per_asvs" = 8) 

  rm(list = ls(pattern = "tmp_"))
}

tmp_tab <- ssu_lefse_sum_tab
tmp_tab <- tmp_tab %>% dplyr::slice(10:12,1:9)
tmp_tab$dataset <- gsub("work", "FULL data set", tmp_tab$dataset)
tmp_tab$dataset <- gsub("filt", "Arbitrary filtered", tmp_tab$dataset)
tmp_tab$dataset <- gsub("perfect", "PERFect filtered", tmp_tab$dataset)
...
tmp_tab <- purrr::modify_at(tmp_tab, .at = c(5,8), ~as.numeric(as.character(.)))
tmp_tab <- purrr::modify_at(tmp_tab, .at = c(3:4,6:7), ~as.integer(as.character(.)))
ssu_lefse_sum_tab <- tmp_tab
ssu_lefse_sum_tab
rm(tmp_tab)
```


<small>`r caption_tab_ssu("ssu_lefse_sum_tab")`</small>

```{r, echo=FALSE, eval=TRUE}
download_this_fun(ssu_lefse_sum_tab)
```

```{r, echo=FALSE, layout="l-page", eval=TRUE}
lefse_summ_table(seq_table)
rm(seq_table)
```
...
<small>`r caption_tab_ssu("ssu_lefse_full_Y0")`</small>

```{r, echo=FALSE, eval=TRUE}
download_this_fun(ssu_ps_work_Y0_lefse_asv_final)
```

```{r, echo=FALSE, layout="l-page", eval=TRUE}
lefse_table(seq_table)
rm(seq_table)
```
:::
...
<small>`r caption_tab_ssu("ssu_lefse_full_Y1")`</small>

```{r, echo=FALSE, eval=TRUE}
download_this_fun(ssu_ps_work_Y1_lefse_asv_final)
```
...
<small>`r caption_tab_ssu("ssu_lefse_full_Y4")`</small>

```{r, echo=FALSE, eval=TRUE}
download_this_fun(ssu_ps_work_Y4_lefse_asv_final)
```
...
<small>`r caption_tab_ssu("ssu_lefse_filt_Y0")`</small>

```{r, echo=FALSE, eval=TRUE}
download_this_fun(ssu_ps_filt_Y0_lefse_asv_final)
```
...
<small>`r caption_tab_ssu("ssu_lefse_filt_Y1")`</small>

```{r, echo=FALSE, eval=TRUE}
download_this_fun(ssu_ps_filt_Y1_lefse_asv_final)
```
...
<small>`r caption_tab_ssu("ssu_lefse_filt_Y4")`</small>

```{r, echo=FALSE, eval=TRUE}
download_this_fun(ssu_ps_filt_Y4_lefse_asv_final)
```
...
<small>`r caption_tab_ssu("ssu_lefse_perfect_Y0")`</small>

```{r, echo=FALSE, eval=TRUE}
download_this_fun(ssu_ps_perfect_Y0_lefse_asv_final)
```
...
<small>`r caption_tab_ssu("ssu_lefse_perfect_Y1")`</small>

```{r, echo=FALSE, eval=TRUE}
download_this_fun(ssu_ps_perfect_Y1_lefse_asv_final)
```
...
<small>`r caption_tab_ssu("ssu_lefse_perfect_Y4")`</small>

```{r, echo=FALSE, eval=TRUE}
download_this_fun(ssu_ps_perfect_Y4_lefse_asv_final)
```
...
<small>`r caption_tab_ssu("ssu_lefse_pime_Y0")`</small>

```{r, echo=FALSE, eval=TRUE}
download_this_fun(ssu_ps_pime_Y0_lefse_asv_final)
```
...
<small>`r caption_tab_ssu("ssu_lefse_pime_Y1")`</small>

```{r, echo=FALSE, eval=TRUE}
download_this_fun(ssu_ps_pime_Y1_lefse_asv_final)
```
...
<small>`r caption_tab_ssu("ssu_lefse_pime_Y4")`</small>

```{r, echo=FALSE, eval=TRUE}
download_this_fun(ssu_ps_pime_Y4_lefse_asv_final)
```
...
```{r, echo=FALSE}
for (i in objects(pattern = "_lefse_asv_final")) {
  tmp_get <- get(i)
  tmp_get <- tmp_get %>% dplyr::rename("reads" = "reads_total")
  tmp_get <- tmp_get %>% dplyr::select(-contains("freq_")) %>% 
                         dplyr::select(-contains("reads_"))
  ...
  tmp_year <- stringr::str_remove(i, "_lefse_asv_final") %>%
                 stringr::str_remove(., ".*_")
  tmp_ds <- stringr::str_remove(i, "_lefse_asv_final") %>%
                 stringr::str_remove(., "_Y[0-9]")
  tmp_group <- paste("group", tmp_year, sep = "_")
  tmp_lefse <- paste("lda", tmp_year, sep = "_")
  tmp_pval <- paste("pval", tmp_year, sep = "_")
  tmp_freq <- paste("freq", tmp_year, sep = "_")
  tmp_reads <- paste("reads", tmp_year, sep = "_")

  tmp_new_names <- c(tmp_group, tmp_lefse, tmp_pval, tmp_freq, tmp_reads)
  tmp_old_names <- c("group", "ef_lda", "pval", "freq", "reads")
  tmp_get <- tmp_get %>% dplyr::rename_with(~tmp_new_names, tmp_old_names)
  tmp_df_name <- paste(tmp_ds, "_", tmp_year, "_to_comb", sep = "")
  assign(tmp_df_name, tmp_get)
  rm(list = ls(pattern = "tmp_"))
}
objects(pattern = "_to_comb")
```

```{r, echo=FALSE}
join_list <- c("ASV_ID", "Kingdom", "Phylum", "Class", "Order", "Family", "Genus", "ASV_SEQ")
reorder_list <- c("ASV_ID", "group_Y0", "group_Y1", "group_Y4", "reads_Y0", "reads_Y1", "reads_Y4", 
                  "freq_Y0", "freq_Y1", "freq_Y4", "lda_Y0", "lda_Y1", "lda_Y4", 
                  "pval_Y0", "pval_Y1", "pval_Y4", 
                  "Kingdom", "Phylum", "Class", "Order", "Family", "Genus", "ASV_SEQ")
ssu_ps_work_lefse_asv_combo <- dplyr::full_join(ssu_ps_work_Y0_to_comb, ssu_ps_work_Y1_to_comb, by = join_list) %>%
  dplyr::full_join(., ssu_ps_work_Y4_to_comb, by = join_list) %>% 
  dplyr::select(all_of(reorder_list))

ssu_ps_filt_lefse_asv_combo <- dplyr::full_join(ssu_ps_filt_Y0_to_comb, ssu_ps_filt_Y1_to_comb, by = join_list) %>%
  dplyr::full_join(., ssu_ps_filt_Y4_to_comb, by = join_list) %>% 
  dplyr::select(all_of(reorder_list))

ssu_ps_perfect_lefse_asv_combo <- dplyr::full_join(ssu_ps_perfect_Y0_to_comb, ssu_ps_perfect_Y1_to_comb, by = join_list) %>%
  dplyr::full_join(., ssu_ps_perfect_Y4_to_comb, by = join_list) %>% 
  dplyr::select(all_of(reorder_list))

ssu_ps_pime_lefse_asv_combo <- dplyr::full_join(ssu_ps_pime_Y0_to_comb, ssu_ps_pime_Y1_to_comb, by = join_list) %>%
  dplyr::full_join(., ssu_ps_pime_Y4_to_comb, by = join_list) %>% 
  dplyr::select(all_of(reorder_list))
...
<small>`r caption_tab_ssu("ssu_ps_work_lefse_combo")`</small>

```{r, echo=FALSE, eval=TRUE}
download_this_fun(ssu_ps_work_lefse_asv_combo)
```

```{r, echo=FALSE, layout="l-page", eval=TRUE}
lefse_combo_table(seq_table)
rm(seq_table)
```
:::
...
<small>`r caption_tab_ssu("ssu_ps_filt_lefse_combo")`</small>

```{r, echo=FALSE, eval=TRUE}
download_this_fun(ssu_ps_filt_lefse_asv_combo)
```
...
<small>`r caption_tab_ssu("ssu_ps_perfect_lefse_combo")`</small>

```{r, echo=FALSE, eval=TRUE}
download_this_fun(ssu_ps_perfect_lefse_asv_combo)
```
...
<small>`r caption_tab_ssu("ssu_ps_pime_lefse_combo")`</small>

```{r, echo=FALSE, eval=TRUE}
download_this_fun(ssu_ps_pime_lefse_asv_combo)
```
...
for (i in samp_ps) {
    ...
    tmp_mt <- tmp_mt %>% dplyr::filter(ef_lda >= lda_cutoff)
    tmp_mt <- tmp_mt  %>% dplyr::mutate(group = factor(group, levels = row_order)) %>% 
                           dplyr::arrange(group)
...
<small>`r caption_tab_ssu("ssu_lefse_marker_work_Y0")`</small>

```{r, echo=FALSE, eval=TRUE}
download_this_fun(ssu_ps_work_Y0_lefse_marker_final)
```

```{r, echo=FALSE, layout="l-page", eval=TRUE}
lefse_marker_table(seq_table)
rm(seq_table)
```
...
<small>`r caption_tab_ssu("ssu_lefse_marker_work_Y1")`</small>

```{r, echo=FALSE, eval=TRUE}
download_this_fun(ssu_ps_work_Y1_lefse_marker_final)
```
...
<small>`r caption_tab_ssu("ssu_lefse_marker_work_Y4")`</small>

```{r, echo=FALSE, eval=TRUE}
download_this_fun(ssu_ps_work_Y4_lefse_marker_final)
```
...
<small>`r caption_tab_ssu("ssu_lefse_marker_filt_Y0")`</small>

```{r, echo=FALSE, eval=TRUE}
download_this_fun(ssu_ps_filt_Y0_lefse_marker_final)
```
...
<small>`r caption_tab_ssu("ssu_lefse_marker_filt_Y1")`</small>

```{r, echo=FALSE, eval=TRUE}
download_this_fun(ssu_ps_filt_Y1_lefse_marker_final)
```
...
<small>`r caption_tab_ssu("ssu_lefse_marker_filt_Y4")`</small>

```{r, echo=FALSE, eval=TRUE}
download_this_fun(ssu_ps_filt_Y4_lefse_marker_final)
```
...
<small>`r caption_tab_ssu("ssu_lefse_marker_perfect_Y0")`</small>

```{r, echo=FALSE, eval=TRUE}
download_this_fun(ssu_ps_perfect_Y0_lefse_marker_final)
```
...
<small>`r caption_tab_ssu("ssu_lefse_marker_perfect_Y1")`</small>

```{r, echo=FALSE, eval=TRUE}
download_this_fun(ssu_ps_perfect_Y1_lefse_marker_final)
```
...
<small>`r caption_tab_ssu("ssu_lefse_marker_perfect_Y4")`</small>

```{r, echo=FALSE, eval=TRUE}
download_this_fun(ssu_ps_perfect_Y4_lefse_marker_final)
```
...
<small>`r caption_tab_ssu("ssu_lefse_marker_pime_Y0")`</small>

```{r, echo=FALSE, eval=TRUE}
download_this_fun(ssu_ps_pime_Y0_lefse_marker_final)
```
...
<small>`r caption_tab_ssu("ssu_lefse_marker_pime_Y1")`</small>

```{r, echo=FALSE, eval=TRUE}
download_this_fun(ssu_ps_pime_Y1_lefse_marker_final)
```
...
<small>`r caption_tab_ssu("ssu_lefse_marker_pime_Y4")`</small>

```{r, echo=FALSE, eval=TRUE}
download_this_fun(ssu_ps_pime_Y4_lefse_marker_final)
```
...
## LEfSe ASV Visualizations

```{r, code_folding=TRUE}
row_order <- c("CTL", "N", "P", "NP") 
min_lda_score <- 3
ssu_asv_no_hits <- c()
for (i in samp_ps) {
     tmp_get <- get(purrr::map_chr(i, ~ paste0(., "_lefse_asv")))
     ...
     tmp_mt$feature <- gsub('s__', '', tmp_mt$feature)
     ### To select top x%
     ### see here for more suggestions: https://stackoverflow.com/questions/33220693/dplyr-group-by-and-select-top-x
     #tmp_mt <- tmp_mt %>% dplyr::select(everything()) %>% 
     #  dplyr::arrange(enrich_group, desc(ef_lda)) %>% 
     #  dplyr::group_by(enrich_group) %>% 
     #  dplyr::slice(seq(n()*.2))
     tmp_mt <- tmp_mt %>% dplyr::filter(ef_lda >= min_lda_score)
     tmp_mt <- tmp_mt  %>% dplyr::mutate(enrich_group = factor(enrich_group, levels = row_order)) %>% 
                           dplyr::arrange(enrich_group)
     
     tmp_mt <- if(nrow(tmp_mt) > 0) {
          tmp_mt <- marker_table(tmp_mt)
        } else {
          ssu_asv_no_hits <- c(append(ssu_asv_no_hits, i))
          print(paste(i, "has no markers with an LDA score greater than", min_lda_score, sep = " "))
        }
...
```{r, code_folding=TRUE}
asv_viz_plot <- function(asv_viz_trim) {
if (class(asv_viz_trim) ==  "character") {
            print(stringr::str_remove(asv_viz_trim, "ssu_ps_") %>%
            stringr::str_replace(., "_", " "))
            } else {
            plot_ef_bar(asv_viz_trim) +
            scale_fill_manual(values = agua_col) + 
...
```{r, echo=FALSE, eval=TRUE, warning=FALSE, layout="l-body"}
asv_viz_plot(ssu_ps_work_Y0_lefse_asv_viz_trim)
```
<small>`r caption_fig_ssu("ssu_lefse_asv_full_Y0")`</small>
:::
...
```{r, echo=FALSE, eval=TRUE, warning=FALSE, layout="l-body"}
asv_viz_plot(ssu_ps_work_Y1_lefse_asv_viz_trim)
```
<small>`r caption_fig_ssu("ssu_lefse_asv_full_Y1")`</small>
:::
...
```{r, echo=FALSE, eval=TRUE, warning=FALSE, layout="l-body"}
asv_viz_plot(ssu_ps_work_Y4_lefse_asv_viz_trim)
```
<small>`r caption_fig_ssu("ssu_lefse_asv_full_Y1")`</small>
:::
:::
...
```{r, echo=FALSE, eval=TRUE, warning=FALSE, layout="l-body"}
asv_viz_plot(ssu_ps_filt_Y0_lefse_asv_viz_trim)
```
<small>`r caption_fig_ssu("ssu_lefse_asv_filt_Y0")`</small>
:::
...
```{r, echo=FALSE, eval=TRUE, warning=FALSE, layout="l-body"}
asv_viz_plot(ssu_ps_filt_Y1_lefse_asv_viz_trim)
```
<small>`r caption_fig_ssu("ssu_lefse_asv_filt_Y1")`</small>
:::
...
```{r, echo=FALSE, eval=TRUE, warning=FALSE, layout="l-body"}
asv_viz_plot(ssu_ps_filt_Y4_lefse_asv_viz_trim)
```
<small>`r caption_fig_ssu("ssu_lefse_asv_filt_Y1")`</small>
:::
:::
...
```{r, echo=FALSE, eval=TRUE, warning=FALSE, layout="l-body"}
asv_viz_plot(ssu_ps_perfect_Y0_lefse_asv_viz_trim)
```
<small>`r caption_fig_ssu("ssu_lefse_asv_perfect_Y0")`</small>
:::
...
```{r, echo=FALSE, eval=TRUE, warning=FALSE, layout="l-body"}
asv_viz_plot(ssu_ps_perfect_Y1_lefse_asv_viz_trim)
```
<small>`r caption_fig_ssu("ssu_lefse_asv_perfect_Y1")`</small>
:::
...
```{r, echo=FALSE, eval=TRUE, warning=FALSE, layout="l-body"}
asv_viz_plot(ssu_ps_perfect_Y4_lefse_asv_viz_trim)
```
<small>`r caption_fig_ssu("ssu_lefse_asv_perfect_Y1")`</small>
:::
:::
...
```{r, echo=FALSE, eval=TRUE, warning=FALSE, layout="l-body"}
asv_viz_plot(ssu_ps_pime_Y0_lefse_asv_viz_trim)
```
<small>`r caption_fig_ssu("ssu_lefse_asv_pime_Y0")`</small>
:::
...
```{r, echo=FALSE, eval=TRUE, warning=FALSE, layout="l-body"}
asv_viz_plot(ssu_ps_pime_Y1_lefse_asv_viz_trim)
```
<small>`r caption_fig_ssu("ssu_lefse_asv_pime_Y1")`</small>
:::
...
```{r, echo=FALSE, eval=TRUE, warning=FALSE, layout="l-body"}
asv_viz_plot(ssu_ps_pime_Y4_lefse_asv_viz_trim)
```
<small>`r caption_fig_ssu("ssu_lefse_asv_pime_Y1")`</small>
:::
:::
...
for (i in samp_ps) {
     ...
     tmp_mt <- if(nrow(tmp_mt) > 0) {
          ...
          ssu_mark_no_hits <- c(append(ssu_mark_no_hits, i))
          print(paste(i, "has no markers with an LDA score greater than", min_lda_score, sep = " "))
        }
...
```{r, code_folding=TRUE}
all_viz_plot <- function(all_viz_trim) {
if (class(all_viz_trim) ==  "character") {
            print(stringr::str_remove(all_viz_trim, "ssu_ps_") %>%
            stringr::str_replace(., "_", " "))
            } else {
            plot_ef_bar(all_viz_trim) +
            scale_fill_manual(values = agua_col) + 
            theme(axis.text = element_text(size = 8)) +
            guides(fill = guide_legend(reverse = TRUE))
            }
...
```{r, echo=FALSE, eval=TRUE, warning=FALSE, layout="l-body"}
all_viz_plot(ssu_ps_work_Y0_lefse_all_viz_trim)
```
<small>`r caption_fig_ssu("ssu_lefse_all_full_Y0")`</small>
:::
...
```{r, echo=FALSE, eval=TRUE, warning=FALSE, layout="l-body"}
all_viz_plot(ssu_ps_work_Y1_lefse_all_viz_trim)
```
<small>`r caption_fig_ssu("ssu_lefse_all_full_Y1")`</small>
:::
...
```{r, echo=FALSE, eval=TRUE, warning=FALSE, layout="l-body"}
all_viz_plot(ssu_ps_work_Y4_lefse_all_viz_trim)
```
<small>`r caption_fig_ssu("ssu_lefse_all_full_Y1")`</small>
:::
:::
...
```{r, echo=FALSE, eval=TRUE, warning=FALSE, layout="l-body"}
all_viz_plot(ssu_ps_filt_Y0_lefse_all_viz_trim)
```
<small>`r caption_fig_ssu("ssu_lefse_all_filt_Y0")`</small>
:::
...
```{r, echo=FALSE, eval=TRUE, warning=FALSE, layout="l-body"}
all_viz_plot(ssu_ps_filt_Y1_lefse_all_viz_trim)
```
<small>`r caption_fig_ssu("ssu_lefse_all_filt_Y1")`</small>
:::
...
```{r, echo=FALSE, eval=TRUE, warning=FALSE, layout="l-body"}
all_viz_plot(ssu_ps_filt_Y4_lefse_all_viz_trim)
```
<small>`r caption_fig_ssu("ssu_lefse_all_filt_Y1")`</small>
:::
:::
...
```{r, echo=FALSE, eval=TRUE, warning=FALSE, layout="l-body"}
all_viz_plot(ssu_ps_perfect_Y0_lefse_all_viz_trim)
```
<small>`r caption_fig_ssu("ssu_lefse_all_perfect_Y0")`</small>
:::
...
```{r, echo=FALSE, eval=TRUE, warning=FALSE, layout="l-body"}
all_viz_plot(ssu_ps_perfect_Y1_lefse_all_viz_trim)
```
<small>`r caption_fig_ssu("ssu_lefse_all_perfect_Y1")`</small>
:::
...
```{r, echo=FALSE, eval=TRUE, warning=FALSE, layout="l-body"}
all_viz_plot(ssu_ps_perfect_Y4_lefse_all_viz_trim)
```
<small>`r caption_fig_ssu("ssu_lefse_all_perfect_Y1")`</small>
:::
:::
...
```{r, echo=FALSE, eval=TRUE, warning=FALSE, layout="l-body"}
all_viz_plot(ssu_ps_pime_Y0_lefse_all_viz_trim)
```
<small>`r caption_fig_ssu("ssu_lefse_all_pime_Y0")`</small>
:::
...
```{r, echo=FALSE, eval=TRUE, warning=FALSE, layout="l-body"}
all_viz_plot(ssu_ps_pime_Y1_lefse_all_viz_trim)
```
<small>`r caption_fig_ssu("ssu_lefse_all_pime_Y1")`</small>
:::
...
```{r, echo=FALSE, eval=TRUE, warning=FALSE, layout="l-body"}
all_viz_plot(ssu_ps_pime_Y4_lefse_all_viz_trim)
```
<small>`r caption_fig_ssu("ssu_lefse_all_pime_Y1")`</small>
:::
:::
...
for (i in objects(pattern = "_lefse_asv_final$")) {
     tmp_get <- get(i)
     tmp_get <- tmp_get[, 1:4]
     tmp_ds <- stringr::str_remove(i, "_Y[0-9]_lefse_asv_final") %>%
               stringr::str_remove(., "ssu_ps_")
       
     tmp_year <- stringr::str_remove(i, "_lefse_asv_final") %>%
                 stringr::str_remove(., ".*_")
     tmp_get$year <- tmp_year
     tmp_get$dataset <- tmp_ds
     tmp_get <- tmp_get %>% relocate(c(dataset, year), .after  = ASV_ID)
     tmp_get$group <- gsub("^Y[0-9]_", "", tmp_get$group)
     
     tmp_get <- tmp_get %>% dplyr::filter(ef_lda >= min_lda_score & pval <= max_p_value)
     
     ssu_asv_chart <- rbind(ssu_asv_chart, tmp_get)
     tmp_res_name <- purrr::map_chr(i, ~ paste0(., "_testing"))
     assign(tmp_res_name, tmp_get)
     rm(list = ls(pattern = "tmp_"))
}
```
...
```{r}
row_order <- c("CTL", "N", "P", "NP") 
ds_order <- c("work", "filt", "perfect", "pime") 
ssu_asv_chart <- ssu_asv_chart  %>% dplyr::mutate(group = factor(group, levels = row_order)) %>% 
                           dplyr::arrange(group)
ssu_asv_chart <- ssu_asv_chart  %>% dplyr::mutate(dataset = factor(dataset, levels = ds_order)) %>% 
                           dplyr::arrange(dataset)
tmp_df <- ssu_asv_chart %>% count(dataset, group, year, sort = TRUE)


ggplot(tmp_df, aes(x = year, y = n, fill = group)) + 
...
ssu_asv_chart <- do.call(rbind, datalist)
objects(pattern = "_testing")

     
      ssu_asv_chart <- c()
      ssu_asv_chart <- c(append(ssu_asv_chart, tmp_get))


     if(tmp_get$dataset[tmp_get$dataset == "work"]) {
...
ggplot(ssu_asv_chart, aes(x = dataset, fill = group)) + geom_bar()
...
remove(list = ls())
load("page_build/da_wf.rdata")
gdata::keep("ssu_ps_work_rf_all", 
            "ssu_ps_work_rf_asv", 
            "ssu_ps_filt_rf_all", 
            "ssu_ps_filt_rf_asv", 
            "ssu_ps_perfect_rf_all", 
            "ssu_ps_perfect_rf_asv", 
            "ssu_ps_pime_rf_all", 
            "ssu_ps_pime_rf_asv", 
            sure = TRUE)
objects()
...
ssu_pht_filt <- filter(data.frame(ssu_pht@result), pvalue <= "0.05")[!grepl("ASV", filter(data.frame(ssu_pht@result), pvalue <= "0.05")$group_name),]
ssu_pht_filt <- ssu_pht_filt[!grepl("[a-z]__$", ssu_pht_filt$group_name),]
ssu_pht_filt <- unique(ssu_pht_filt$group_name)
length(ssu_pht_filt)
save.image("page_build/mmarker_wf.rdata")
```

There are **`r length(ssu_pht_filt)`** significantly different lineage markers.
...
Now we select a subset of the `r length(ssu_pht_filt)` markers to plot and visualize the results.
...
its_ps_filt <- readRDS("files/perfect/rdata/its_ps_filt.rds")
its_ps_perfect <- readRDS("files/perfect/rdata/its_ps_perfect.rds")
its_ps_pime <- readRDS("files/pime/rdata/its_ps_pime.rds")
```


```{r, echo=FALSE}	
samp_ps <- c("its_ps_work", "its_ps_filt", "its_ps_perfect", "its_ps_pime")	
for (i in samp_ps) {	
	  tmp_get <- get(i)	
	  tmp_path <- file.path("files/alpha/rdata/")	
	  tmp_read <- readRDS(paste(tmp_path, i, ".rds", sep = ""))	
...
```{r, echo=FALSE, eval=TRUE}
seq_table <- its_ps_work_indval_final
seq_table %>%
  download_this(
...
```{r, echo=FALSE, eval=TRUE}
seq_table <- its_ps_filt_indval_final
seq_table %>%
  download_this(
...
```{r, echo=FALSE, eval=TRUE}
seq_table <- its_ps_perfect_indval_final
seq_table %>%
  download_this(
...
```{r, echo=FALSE, eval=TRUE}
seq_table <- its_ps_pime_indval_final
seq_table %>%
  download_this(
...
```{r, echo=FALSE}
# DONT RUN, TESTING ONLY
#tmp_tab <- data.frame(marker_table(its_ps_pime_lefse_asv))
#tmp_tab$feature <- gsub('s__', '', tmp_tab$feature)

#tmp_ps <- data.frame(t(otu_table(its_ps_pime_rf_asv)))
#tmp_ps <- tmp_ps %>% tibble::rownames_to_column("feature")
#write.table(dplyr::left_join(tmp_tab, tmp_ps, by = "feature"), "test.txt", quote = FALSE, sep = "\t")
```
...
```{r, echo=FALSE, eval=TRUE}
seq_table <- its_ps_work_lefse_final
seq_table %>%
  download_this(
...
```{r, echo=FALSE, eval=TRUE}
seq_table <- its_ps_filt_lefse_final
seq_table %>%
  download_this(
...
```{r, echo=FALSE, eval=TRUE}
seq_table <- its_ps_perfect_lefse_final
seq_table %>%
  download_this(
...
```{r, echo=FALSE, eval=TRUE}
seq_table <- its_ps_pime_lefse_final
seq_table %>%
  download_this(
...
```{r, echo=FALSE, eval=TRUE, warning=FALSE, layout="l-body-outset"}
plot_ef_bar(its_ps_work_lefse_asv_viz_trim) +
...
```{r, echo=FALSE, eval=TRUE, warning=FALSE, layout="l-body-outset"}
plot_ef_bar(its_ps_filt_lefse_asv_viz_trim) +
  scale_fill_manual(values = c("0" = "#2271B2", "3" = "#71B222", "8" = "#B22271")) + 
  theme(axis.text = element_text(size = 8))
```
...
#### PIME filtered
```{r, echo=FALSE, eval=TRUE, warning=FALSE, layout="l-body-outset"}
plot_ef_bar(its_ps_pime_lefse_asv_viz_trim) +
  scale_fill_manual(values = c("0" = "#2271B2", "3" = "#71B222", "8" = "#B22271")) + 
...
```{r, echo=FALSE, eval=TRUE, warning=FALSE, layout="l-body-outset"}
plot_ef_bar(its_ps_perfect_lefse_asv_viz_trim) +
  scale_fill_manual(values = c("0" = "#2271B2", "3" = "#71B222", "8" = "#B22271")) + 
...
```{r, echo=FALSE, eval=TRUE}
seq_table <- its_ps_work_lefse_marker_final
seq_table %>%
  download_this(
...
```{r, echo=FALSE, eval=TRUE}
seq_table <- its_ps_filt_lefse_marker_final
seq_table %>%
  download_this(
...
```{r, echo=FALSE, eval=TRUE}
seq_table <- its_ps_perfect_lefse_marker_final
seq_table %>%
  download_this(
...
```{r, echo=FALSE, eval=TRUE}
seq_table <- its_ps_pime_lefse_marker_final
seq_table %>%
  download_this(
...
```{r, echo=FALSE, eval=TRUE, warning=FALSE, layout="l-body-outset"}
plot_ef_bar(its_ps_work_lefse_all_viz_trim) +
  scale_fill_manual(values = c("0" = "#2271B2", "3" = "#71B222", "8" = "#B22271")) + 	
	  theme(axis.text = element_text(size = 8))
```
...
```{r, echo=FALSE, eval=TRUE, warning=FALSE, layout="l-body-outset"}
plot_ef_bar(its_ps_filt_lefse_all_viz_trim) +
  scale_fill_manual(values = c("0" = "#2271B2", "3" = "#71B222", "8" = "#B22271")) + 	
	  theme(axis.text = element_text(size = 8))
```
...
```{r, echo=FALSE, eval=TRUE, warning=FALSE, layout="l-body-outset"}
plot_ef_bar(its_ps_perfect_lefse_all_viz_trim) +
  scale_fill_manual(values = c("0" = "#2271B2", "3" = "#71B222", "8" = "#B22271")) + 	
	  theme(axis.text = element_text(size = 8))
```
...
#### PIME filtered
```{r, echo=FALSE, eval=TRUE, warning=FALSE, layout="l-body-outset"}
plot_ef_bar(its_ps_pime_lefse_all_viz_trim) +
  scale_fill_manual(values = c("0" = "#2271B2", "3" = "#71B222", "8" = "#B22271")) + 	
	  theme(axis.text = element_text(size = 8))
```
...
remove(list = ls())
load("page_build/da_wf.rdata")
gdata::keep("its_ps_work_rf_all", 
            "its_ps_work_rf_asv", 
            "its_ps_filt_rf_all", 
            "its_ps_filt_rf_asv", 
            "its_ps_perfect_rf_all", 
            "its_ps_perfect_rf_asv", 
            "its_ps_pime_rf_all", 
            "its_ps_pime_rf_asv", 
            sure = TRUE)
objects()
...
its_pht_filt <- filter(data.frame(its_pht@result), pvalue <= "0.05")[!grepl("ASV", filter(data.frame(its_pht@result), pvalue <= "0.05")$group_name),]
its_pht_filt <- its_pht_filt[!grepl("[a-z]__$", its_pht_filt$group_name),]
its_pht_filt <- unique(its_pht_filt$group_name)
length(its_pht_filt)
```

There are **`r length(its_pht_filt)`** significantly different lineage markers.
...
```{r, code_folding=TRUE}
samp_ps_all <- c("ssu_ps_filt", "ssu_ps_pime", "ssu_ps_perfect")
samp_ps <- c("ssu_ps_filt", "ssu_ps_pime", "ssu_ps_perfect")
samp_ps_org <- c("ssu_ps_work")
samp_ps_pime <- c("ssu_ps_pime")
samp_ps_other <- c("ssu_ps_filt", "ssu_ps_perfect")
...
tmp_x <- readRDS("files/alpha/rdata/ssu_ps_pime.rds")
...
```{r, code_folding=TRUE}
samp_ps_all <- c("its_ps_filt", "its_ps_pime", "its_ps_perfect", 
                 "its_ps_filt_otu", "its_ps_pime_otu", "its_ps_perfect_otu", 
                 "its_ps_work", "its_ps_work_otu")
samp_ps <- c("its_ps_filt", "its_ps_pime", "its_ps_perfect", 
             "its_ps_filt_otu", "its_ps_pime_otu", "its_ps_perfect_otu")
samp_ps_org <- c("its_ps_work", "its_ps_work_otu")
samp_ps_pime <- c("its_ps_pime", "its_ps_pime_otu")
samp_ps_other <- c("its_ps_filt", "its_ps_perfect", 
                   "its_ps_filt_otu", "its_ps_perfect_otu")
...
its_ps_pime_trim
its_ps_perfect_trim
its_ps_filt_otu_trim
its_ps_pime_otu_trim
its_ps_perfect_otu_trim
```
...
tmp_x <- readRDS("files/alpha/rdata/its_ps_pime.rds")
data.frame(sample_data(tmp_x))
metadata_tab[,c(2:5)] <- list(NULL)
for (i in samp_ps_all) {
     tmp_get <- get(i)
...
```{r, echo=FALSE}
# ALL commands
#anvi-interactive --view-data data_its_ps_pime.txt --tree asv_its_ps_pime.tre --additional-layers additional_layers_its_ps_pime.txt --profile-db profile_its_ps_pime.db --fasta-file its_ps_pime.fasta --manual

#anvi-import-misc-data additional_views_its_ps_pime.txt --pan-or-profile-db profile_its_ps_pime.db --target-data-table layers

#anvi-import-misc-data sample_its_ps_pime.tre --pan-or-profile-db profile_its_ps_pime.db --target-data-table layer_orders

#anvi-import-misc-data tax_layers_its_ps_pime.txt --pan-or-profile-db profile_its_ps_pime.db --target-data-table layers
