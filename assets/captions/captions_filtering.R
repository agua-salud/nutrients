...
caption_tab_ssu("ssu_perfect_filt_samples", "Sample summary showing the number of reads and ASVs after PERfect filtering.")
caption_tab_its("its_perfect_filt_samples", "Sample summary showing the number of reads and ASVs after PERfect filtering.")
